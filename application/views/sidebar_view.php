...
<style>
  /* --- KOTAK HEADER & ACTIVE (Tetap Coklat Tua) --- */
  .sidebar-menu > li.header {
      background-color: #4878a2 !important; 
  ...
  /* --- SEMUA TULISAN DI LUAR BAR (MENJADI PUTIH) --- */
  /* 1. Nama user ("Pororo") & Level ("Petugas") */
  .user-panel .info p, 
  .user-panel .info a {
      color: #ffffff !important;
  }
  
  /* 2. Menu Utama biasa (Data Pengguna, Data, Transaksi, dll) beserta icon & panah */
  .sidebar-menu > li > a,
  .sidebar-menu > li > a i,
  ...
  /* 3. Sub-menu di dalam dropdown (Data Buku, Kategori, Rak, dll) */
  ...
  /* 4. Efek hover saat menu ditunjuk mouse (opsional, agar lebih interaktif) */
  .sidebar-menu > li:hover > a {
      background-color: rgba(255, 255, 255, 0.1) !important;
  }
</style><style>
  /* --- KOTAK HEADER & ACTIVE (Coklat Tua) --- */
  .sidebar-menu > li.header {
      background-color: #4878a2 !important; 
      color: #ffffff !important;
  }
  ...
  /* --- BACKGROUND DROPDOWN SUB-MENU (Mengubah dari Putih ke Coklat Tua) --- */
  .sidebar-menu .treeview-menu {
      background-color: #122753 !important; /* Warna coklat gelap agar teks putih terbaca */
  }
  ...
  /* 4. Efek hover saat menu ditunjuk mouse */
  .sidebar-menu > li:hover > a,
  .sidebar-menu .treeview-menu > li:hover > a {
      background-color: rgba(255, 255, 255, 0.1) !important;
  }
</style>
<aside class="main-sidebar" style="background-image: url('<?php echo base_url();?>assets_style/image/bukupanjang.jpeg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
